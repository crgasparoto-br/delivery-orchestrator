...
test('CI emits generated worker bytes in logs only when strict compile detects drift', async () => {
  ...
  assert.doesNotMatch(body, /contents: write|actions\/upload-artifact/);
});