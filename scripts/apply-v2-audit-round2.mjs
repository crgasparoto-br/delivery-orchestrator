...
const parts = [
  'scripts/.v2-r2-part-00',
  'scripts/.v2-r2-part-01',
  'scripts/.v2-r2-part-02',
  'scripts/.v2-r2-part-03',
  'scripts/.v2-r2-part-04'
];
const temp = `${process.env.RUNNER_TEMP || '/tmp'}/apply-v2-audit-round2.mjs`;
try {
