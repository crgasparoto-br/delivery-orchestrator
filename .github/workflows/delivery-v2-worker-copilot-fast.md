...
pre-steps:
  ...
  - name: Validate controller-selected worker authorization
    ...
    env:
      ...
      EXPECTED_RISK: fast
      EXPECTED_MODEL: ${{ vars.DELIVERY_FAST_IMPLEMENTER_MODEL || vars.DELIVERY_IMPLEMENTER_MODEL || 'gpt-5.3-codex' }}
...
engine:
  id: copilot
  model: ${{ vars.DELIVERY_FAST_IMPLEMENTER_MODEL || vars.DELIVERY_IMPLEMENTER_MODEL || 'gpt-5.3-codex' }}
  env:
    GH_AW_MAX_AI_CREDITS: ${{ vars.DELIVERY_FAST_MAX_AI_CREDITS || '100' }}
max-turns: ${{ vars.DELIVERY_FAST_MAX_AI_TURNS || '20' }}
timeout-minutes: 20
network:
