...
export function loadConfig(args = {}) {
  ...
  return {
    ...
    ciWaitTimeoutSeconds: int('CI_WAIT_TIMEOUT_SECONDS', 1800),
    ciDiscoveryGraceSeconds: int('CI_DISCOVERY_GRACE_SECONDS', 30),
    ciPollIntervalSeconds: int('CI_POLL_INTERVAL_SECONDS', 15),
