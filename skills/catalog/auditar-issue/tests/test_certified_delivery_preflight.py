    ...
    matrix.write_text(json.dumps({
        ...
        "requirements": [{
            ...
            "risk_surfaces": [{
                ...
                "reason": "Handoff evidence must bind the procedure and observed outcome to its declared control boundary.",
            }],
            "plausible_wrong_implementation": "Accept generic handoff control evidence that never proves the declared handoff evidence boundary.",
            "positive_control": {"status": "passed", "head_sha": HEAD},
            "negative_controls": [{
                "id": "HANDOFF-SEMANTIC-001",
                "status": "passed",
                "head_sha": HEAD,
                "evidence_sha256": "1" * 64,
                "risk_family": "structural-contract",
                "surface": "handoff-control-evidence",
                "dimension": "material-head-binding",
                "failure_mode": "Handoff control evidence can claim success without proving the material head binding boundary.",
                "plausible_wrong_implementation": "Accept handoff control evidence that omits the concrete material head binding boundary.",
                "procedure": "Validate handoff control evidence and inspect the material head binding decision.",
                "expected": "The handoff evidence validator accepts only material head binding evidence tied to the declared boundary.",
                "observed": "The handoff evidence validator accepted the material head binding evidence tied to that boundary.",
                "semantic_evidence": {
                    "mechanism": {
                        "surface": "handoff-control-evidence",
                        "dimension": "material-head-binding",
                        "target": "handoff control evidence material head binding boundary",
                    },
                    "procedure": {
                        "operation": "validate",
                        "stimulus": "validate handoff control evidence for the material head binding boundary",
                        "observable": "handoff evidence validator returns the material head binding boundary decision",
                    },
                    "outcome": {
                        "expected_signal": "handoff evidence validator accepts the material head binding boundary",
                        "observed_signal": "handoff evidence validator accepted the material head binding boundary",
                        "evidence_sha256": "1" * 64,
                    },
                },
            }],
